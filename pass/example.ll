...
define dso_local void @_Z4strrSt10shared_ptrI7MyClassE(%"class.std::shared_ptr"* noundef %0) #4 {
  %2 = bitcast %"class.std::shared_ptr"* %0 to %"class.std::__shared_ptr_access"*
  %3 = call noundef %class.MyClass* @_ZNKSt19__shared_ptr_accessI7MyClassLN9__gnu_cxx12_Lock_policyE2ELb0ELb0EEptEv(%"class.std::__shared_ptr_access"* noundef nonnull align 1 dereferenceable(1) %2) #3
  call void @_ZN7MyClass5printEv(%class.MyClass* noundef nonnull align 1 dereferenceable(1) %3)
  ret void
}
...
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaI7MyClassEE9constructIS0_JEEEvRS1_PT_DpOT0_(%"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %0, %class.MyClass* noundef %1) #4 comdat align 2 {
  ...
  %5 = load %"class.std::allocator"*, %"class.std::allocator"** %3, align 8
  %6 = bitcast %"class.std::allocator"* %5 to %"class.__gnu_cxx::new_allocator"*
  %7 = load %class.MyClass*, %class.MyClass** %4, align 8
  call void @_ZN9__gnu_cxx13new_allocatorI7MyClassE9constructIS1_JEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* noundef nonnull align 1 dereferenceable(1) %6, %class.MyClass* noundef %7)
  ret void
}
...
define linkonce_odr dso_local void @_ZNSt23_Sp_counted_ptr_inplaceI7MyClassSaIS0_ELN9__gnu_cxx12_Lock_policyE2EE10_M_destroyEv(%"class.std::_Sp_counted_ptr_inplace"* noundef nonnull align 8 dereferenceable(24) %0) unnamed_addr #5 comdat align 2 {
  ...
  %7 = call noundef nonnull align 1 dereferenceable(1) %"class.std::allocator"* @_ZNSt23_Sp_counted_ptr_inplaceI7MyClassSaIS0_ELN9__gnu_cxx12_Lock_policyE2EE5_Impl8_M_allocEv(%"class.std::_Sp_counted_ptr_inplace<MyClass, std::allocator<MyClass>, __gnu_cxx::_S_atomic>::_Impl"* noundef nonnull align 1 dereferenceable(1) %6) #3
  call void @_ZNSaISt23_Sp_counted_ptr_inplaceI7MyClassSaIS0_ELN9__gnu_cxx12_Lock_policyE2EEEC2IS0_EERKSaIT_E(%"class.std::allocator.0"* noundef nonnull align 1 dereferenceable(1) %3, %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %7) #3
  call void @_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceI7MyClassSaIS1_ELN9__gnu_cxx12_Lock_policyE2EEEEC2ERS6_PS5_(%"struct.std::__allocated_ptr"* noundef nonnull align 8 dereferenceable(16) %4, %"class.std::allocator.0"* noundef nonnull align 1 dereferenceable(1) %3, %"class.std::_Sp_counted_ptr_inplace"* noundef %5) #3
  call void @_ZNSt23_Sp_counted_ptr_inplaceI7MyClassSaIS0_ELN9__gnu_cxx12_Lock_policyE2EED2Ev(%"class.std::_Sp_counted_ptr_inplace"* noundef nonnull align 8 dereferenceable(24) %5) #3
  call void @_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceI7MyClassSaIS1_ELN9__gnu_cxx12_Lock_policyE2EEEED2Ev(%"struct.std::__allocated_ptr"* noundef nonnull align 8 dereferenceable(16) %4) #3
  call void @_ZNSaISt23_Sp_counted_ptr_inplaceI7MyClassSaIS0_ELN9__gnu_cxx12_Lock_policyE2EEED2Ev(%"class.std::allocator.0"* noundef nonnull align 1 dereferenceable(1) %3) #3
  ret void
}
...
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorI7MyClassE9constructIS1_JEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* noundef nonnull align 1 dereferenceable(1) %0, %class.MyClass* noundef %1) #5 comdat align 2 {
  ...
  store %class.MyClass* %1, %class.MyClass** %4, align 8
  %5 = load %"class.__gnu_cxx::new_allocator"*, %"class.__gnu_cxx::new_allocator"** %3, align 8
  %6 = load %class.MyClass*, %class.MyClass** %4, align 8
  %7 = bitcast %class.MyClass* %6 to i8*
  %8 = bitcast i8* %7 to %class.MyClass*
  ret void
}
...
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaI7MyClassEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %0, %class.MyClass* noundef %1) #4 comdat align 2 {
  ...
  %6 = bitcast %"class.std::allocator"* %5 to %"class.__gnu_cxx::new_allocator"*
  %7 = load %class.MyClass*, %class.MyClass** %4, align 8
  call void @_ZN9__gnu_cxx13new_allocatorI7MyClassE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator"* noundef nonnull align 1 dereferenceable(1) %6, %class.MyClass* noundef %7)
  ret void
}
